...
public class ProviderHelper {
    ...
    public SaveKeyringResult savePublicKeyRing(UncachedKeyRing keyRing) {
        return savePublicKeyRing(keyRing, new ProgressScaler(), null, null, null, false);
    }
    ...
    public SaveKeyringResult savePublicKeyRing(UncachedKeyRing publicRing, Progressable progress,
                                               ...
                                               ArrayList<CanonicalizedSecretKeyRing> canSecretKeyRings,
                                               ArrayList<CanonicalizedPublicKeyRing> canPublicKeyRings,
                                               boolean skipSave) {
        ...
        try {
            ...
            if (canPublicKeyRings != null) canPublicKeyRings.add(canPublicRing);
            ...
            if (canSecretRing != null) {
                ...
                if (canSecretKeyRings != null) canSecretKeyRings.add(canSecretRing);
    ...
    public SaveKeyringResult saveSecretKeyRing(UncachedKeyRing secretRing, Progressable progress) {
        return saveSecretKeyRing(secretRing, progress, null, null, false);
    }
